...
def grep(attrname):
    ...
    file_path = os.path.join(os.path.dirname(__file__), 'pycss/__init__.py')
...
setup(
    name = grep('__title__'), # name of the main package (base folder i.e pycss)
    ...
    url = grep('__url__'),
    download_url = 'https://pypi.org/project/pycss',
    ...
    packages = find_packages(), # OR packages=['pycss'] 
